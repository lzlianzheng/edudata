...
<form action="keji.php" method="get" class="disin">
...
if(count($result) > 0){
	foreach($result as $v){
		echo "<form action='keji_insert.php' id='$v->sid'><tr>
			...
			<td><input type='text' name='time' value='' maxlength='20'/></td>
			<td><input type='text' name='unit' value='' maxlength='50'/></td>
