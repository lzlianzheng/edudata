...
{
$id = $_GET['id'];
$sql = "select * from weisheng_sch where id = '$id'";
...
?>
<div class="menu tc">
<h2 style="text-align:center;display:inline-block">公寓卫生-校级</h2><br/>
<a href="<?php echo "weisheng_sch_score.php?act=stat&s_major=$major&s_year=$grade&s_class=$classn&xuenian=$sxuenian&xueqi=$sxueqi&zhouci=$zhouci"; ?>">返回</a>　
</div>
<form action="modify.php?act=weisheng_sch" method="post">
