...
$sxueqi = $_GET["xueqi"];
$zhouci = $_GET["zhouci"];
$sql = "select * from zaocao_class where id = '$id'";
...
<div class="menu tc">
<h2 style="text-align:center;display:inline-block">班级早操考核周记录</h2>
<br><a href="<?php echo "zaocao_class_score.php?act=zaocao_score&sname=$sname&sid=$sid&s_major=$major&s_year=$grade&s_class=$classn&xuenian=$sxuenian&xueqi=$sxueqi&zhouci=$zhouci"; ?>">返回</a>　
</div>
<form action="modify.php?act=zaocao_class_save" method="post">
