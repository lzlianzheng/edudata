...
require_once 'getuid.php';	
	...
	if($_REQUEST['act'] =='out')
	{
		...
		Header("Content-Disposition: attachment; filename=class_ganbu.xls");
		$tnow = "		
		<td>学号</td>
		<td>姓名</td>
		<td>班级</td>
...
?>
	...
	<div class="menu">
	<a href="cp_cla_leader_s.php">普通录入</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="<?php echo "cp_cla_leader.php?act=out&sname=$sname&sid=$sid&s_major=$major&s_year=$grade&s_class=$classn&xuenian=$sxuenian&xueqi=$sxueqi"; ?>">导出数据</a>
	<br>
